    ...
    function(t) {
        ...
        function v(t, e) {
            ...
            if (t !== u && e !== u || r.contains(i))
                return "BODY" === (s = (a = u).nodeName) || "HTML" !== s && d(a.firstElementChild) !== a ? d(u) : u;
            var l = p(t);
        ...
        function k(t, e) {
            ...
            return (r && !n ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (p = m(p, e)),
            p
        }
        function A(t) {
        ...
        function Y(t, e) {
            Object.keys(e).forEach((function(n) {
                var r = "";
                -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && X(e[n]) && (r = "px"),
                t.style[n] = e[n] + r
            }
            ))
        }
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        var i = t.placement.split("-")[0]
                          ...
                          , p = l ? "bottom" : "right"
                          , v = R(r)[c];
                        u[p] - v < s[h] && (t.offsets.popper[h] -= s[h] - (u[p] - v)),
                        u[h] + v > s[p] && (t.offsets.popper[h] += u[h] + v - s[p]),
                        ...
                        return b = Math.max(Math.min(s[c] - v, b), 0),
                        t.arrowElement = r,
                        t.offsets.arrow = (E(n = {}, h, Math.round(b)),
                        E(n, d, ""),
                        n),
                        t
                    },
                ...
                flip: {
                    ...
                    fn: function(t, e) {
                        ...
                        return a.forEach((function(s, u) {
                            ...
                            t.placement = r + (o ? "-" + o : ""),
                            t.offsets.popper = T({}, t.offsets.popper, q(t.instance.popper, t.offsets.reference, t.placement)),
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        ...
                        var a = void 0 !== o ? o : e.gpuAcceleration
                          ...
                          , v = void 0
                          , g = void 0;
                        if (g = "bottom" === f ? "HTML" === s.nodeName ? -s.clientHeight + c.bottom : -u.height + c.bottom : c.top,
                        v = "right" === h ? "HTML" === s.nodeName ? -s.clientWidth + c.right : -u.width + c.right : c.left,
                        a && p)
                            l[p] = "translate3d(" + v + "px, " + g + "px, 0)",
                            l[f] = 0,
                            l[h] = 0,
                        ...
                        return t.attributes = T({}, _, t.attributes),
...
, function(t, e, n) {
    ...
    o = function(n, i) {
        ...
        v.extend = v.fn.extend = function() {
            ...
            s--); s < u; s++)
                if (null != (t = arguments[s]))
                    for (e in t)
                        n = a[e],
                        a !== (r = t[e]) && (l && r && (v.isPlainObject(r) || (i = v.isArray(r))) ? (i ? (i = !1,
                        o = n && v.isArray(n) ? n : []) : o = n && v.isPlainObject(n) ? n : {},
                        a[e] = v.extend(l, o, r)) : void 0 !== r && (a[e] = r));
            return a
        }
        ,
        v.extend({
            ...
            isPlainObject: function(t) {
                var e;
                if ("object" !== v.type(t) || t.nodeType || v.isWindow(t))
                    return !1;
            ...
            globalEval: function(t) {
                var e, n = eval;
                (t = v.trim(t)) && (1 === t.indexOf("use strict") ? ((e = a.createElement("script")).text = t,
            ...
            makeArray: function(t, e) {
                var n = e || [];
                return null != t && (b(Object(t)) ? v.merge(n, "string" == typeof t ? [t] : t) : l.call(n, t)),
                n
            },
        ...
        var w = function(t) {
            var e, n, r, i, o, a, s, u, l, c, f, h, d, p, v, g, m, y, _, b = "sizzle" + 1 * new Date, w = t.document, x = 0, E = 0, T = it(), C = it(), S = it(), k = function(t, e) {
                return t === e && (f = !0),
                0
            }, A = {}.hasOwnProperty, N = [], j = N.pop, D = N.push, O = N.push, I = N.slice, L = function(t, e) {
                for (var n = 0, r = t.length; n < r; n++)
                    if (t[n] === e)
                        return n;
                return -1
            }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", P = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", F = "\\[" + P + "*(" + q + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + q + "))|)" + P + "*\\]", H = ":(" + q + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", M = new RegExp(P + "+","g"), B = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$","g"), W = new RegExp("^" + P + "*," + P + "*"), z = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"), U = new RegExp("=" + P + "*([^\\]'\"]*?)" + P + "*\\]","g"), $ = new RegExp(H), Q = new RegExp("^" + q + "$"), V = {
                ID: new RegExp("^#(" + q + ")"),
                CLASS: new RegExp("^\\.(" + q + ")"),
                TAG: new RegExp("^(" + q + "|[*])"),
                ATTR: new RegExp("^" + F),
            ...
            }, X = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = /'|\\/g, tt = new RegExp("\\\\([\\da-f]{1,6}" + P + "?|(" + P + ")|.)","ig"), et = function(t, e, n) {
                var r = "0x" + e - 65536;
            ...
            function rt(t, e, r, i) {
                var o, s, l, c, f, p, m, y, x = e && e.ownerDocument, E = e ? e.nodeType : 9;
                if (r = r || [],
                "string" != typeof t || !t || 1 !== E && 9 !== E && 11 !== E)
                    return r;
                if (!i && ((e ? e.ownerDocument || e : w) !== d && h(e),
                e = e || d,
                v)) {
                    if (11 !== E && (p = G.exec(t)))
                        if (o = p[1]) {
                            if (9 === E) {
                                ...
                                if (l.id === o)
                                    return r.push(l),
                                    r
                            } else if (x && (l = x.getElementById(o)) && _(e, l) && l.id === o)
                                return r.push(l),
                                r
                        } else {
                            if (p[2])
                    ...
                    if (n.qsa && !S[t + " "] && (!g || !g.test(t))) {
                        if (1 !== E)
                            ...
                            for ((c = e.getAttribute("id")) ? c = c.replace(Z, "\\$&") : e.setAttribute("id", c = b),
                            s = (m = a(t)).length,
                            f = Q.test(c) ? "#" + c : "[id='" + c + "']"; s--; )
                                m[s] = f + " " + pt(m[s]);
                            y = m.join(","),
                            x = J.test(t) && ht(e.parentNode) || e
                        }
                        if (y)
                            try {
                                return O.apply(r, x.querySelectorAll(y)),
                                r
                            } catch (t) {} finally {
            ...
            h = rt.setDocument = function(t) {
                ...
                v = !o(d),
                (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", nt, !1) : i.attachEvent && i.attachEvent("onunload", nt)),
                ...
                (n.qsa = K.test(d.querySelectorAll)) && (at((function(t) {
                    ...
                    t.querySelectorAll("[selected]").length || g.push("\\[" + P + "*(?:value|" + R + ")"),
                ...
                _ = e || K.test(p.contains) ? function(t, e) {
                ...
                k = e ? function(t, e) {
                    ...
                    return r || (1 & (r = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !n.sortDetached && e.compareDocumentPosition(t) === r ? t === d || t.ownerDocument === w && _(w, t) ? -1 : e === d || e.ownerDocument === w && _(w, e) ? 1 : c ? L(c, t) - L(c, e) : 0 : 4 & r ? -1 : 1)
                }
                : function(t, e) {
                    if (t === e)
                        return f = !0,
                    ...
                    if (!i || !o)
                        return t === d ? -1 : e === d ? 1 : i ? -1 : o ? 1 : c ? L(c, t) - L(c, e) : 0;
                    if (i === o)
                        return ut(t, e);
            ...
            rt.matchesSelector = function(t, e) {
                ...
                e = e.replace(U, "='$1']"),
                n.matchesSelector && v && !S[e + " "] && (!m || !m.test(e)) && (!g || !g.test(e)))
                    try {
                        var r = y.call(t, e);
            ...
            (r = rt.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(t) {
                        var e, n = !t[6] && t[2];
                        return V.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && $.test(n) && (e = a(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                        t[2] = n.slice(0, e)),
                        t.slice(0, 3))
                    }
                },
                filter: {
                    ...
                    ATTR: function(t, e, n) {
                        return function(r) {
                            var i = rt.attr(r, t);
                            return null == i ? "!=" === e : !e || (i += "",
                            "=" === e ? i === n : "!=" === e ? i !== n : "^=" === e ? n && 0 === i.indexOf(n) : "*=" === e ? n && i.indexOf(n) > -1 : "$=" === e ? n && i.slice(-n.length) === n : "~=" === e ? (" " + i.replace(M, " ") + " ").indexOf(n) > -1 : "|=" === e && (i === n || i.slice(0, n.length + 1) === n + "-"))
                        }
                    },
                    CHILD: function(t, e, n, r, i) {
                        ...
                        : function(e, n, u) {
                            var l, c, f, h, d, p, v = o !== a ? "nextSibling" : "previousSibling", g = e.parentNode, m = s && e.nodeName.toLowerCase(), y = !u && !s, _ = !1;
                            if (g) {
                                if (o) {
                                    for (; v; ) {
                                        for (h = e; h = h[v]; )
                                ...
                                a && y) {
                                    for (_ = (d = (l = (c = (f = (h = g)[b] || (h[b] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[t] || [])[0] === x && l[1]) && l[2],
                                    h = d && g.childNodes[d]; h = ++d && h && h[v] || (_ = d = 0) || p.pop(); )
                                        if (1 === h.nodeType && ++_ && h === e) {
                                            c[t] = [x, d, _];
                                            break
                                        }
                                } else if (y && (_ = d = (l = (c = (f = (h = e)[b] || (h[b] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[t] || [])[0] === x && l[1]),
                                !1 === _)
                                    for (; (h = ++d && h && h[v] || (_ = d = 0) || p.pop()) && ((s ? h.nodeName.toLowerCase() !== m : 1 !== h.nodeType) || !++_ || (y && ((c = (f = h[b] || (h[b] = {}))[h.uniqueID] || (f[h.uniqueID] = {}))[t] = [x, _]),
                                    h !== e)); )
                                        ;
                ...
                pseudos: {
                    ...
                    lang: ot((function(t) {
                        return Q.test(t || "") || rt.error("unsupported lang: " + t),
            ...
            function vt(t, e, n) {
                ...
                : function(e, n, a) {
                    ...
                    if (a) {
                        ...
                        for (; e = e[r]; )
                            if (1 === e.nodeType || i) {
                                if ((s = (u = (l = e[b] || (e[b] = {}))[e.uniqueID] || (l[e.uniqueID] = {}))[r]) && s[0] === x && s[1] === o)
                                    return c[2] = s[2];
                                if (u[r] = c,
                                c[2] = t(e, n, a))
                                    return !0
            ...
            function yt(t, e, n, r, i, o) {
                ...
                i && !i[b] && (i = yt(i, o)),
                ot((function(o, a, s, u) {
                    var l, c, f, h = [], d = [], p = a.length, v = o || function(t, e, n) {
                        for (var r = 0, i = e.length; r < i; r++)
                            rt(t, e[r], n);
                        return n
                    }(e || "*", s.nodeType ? [s] : s, []), g = !t || !o && e ? v : mt(v, h, t, s, u), m = n ? i || (o ? t : p || r) ? [] : a : g;
                    if (n && n(g, m, s, u),
                    r)
                        for (l = mt(m, d),
                        r(l, [], s, u),
                    ...
                    if (o) {
                        if (i || t) {
                            ...
                            for (c = m.length; c--; )
                                (f = m[c]) && (l = i ? L(o, f) : h[c]) > -1 && (o[l] = !(a[l] = f))
                        }
                    } else
                        m = mt(m === a ? m.splice(p, m.length) : m),
                        i ? i(null, a, m, u) : O.apply(a, m)
                }
                ))
            }
            function _t(t) {
                for (var e, n, i, o = t.length, a = r.relative[t[0].type], s = a || r.relative[" "], u = a ? 1 : 0, c = vt((function(t) {
                    return t === e
                }
                ), s, !0), f = vt((function(t) {
                    return L(e, t) > -1
                    ...
                    if (n = r.relative[t[u].type])
                        ...
                        if ((n = r.filter[t[u].type].apply(null, t[u].matches))[b]) {
                            for (i = ++u; i < o && !r.relative[t[i].type]; i++)
                                ;
                            return yt(u > 1 && gt(h), u > 1 && pt(t.slice(0, u - 1).concat({
                                value: " " === t[u - 2].type ? "*" : ""
                            })).replace(B, "$1"), n, u < i && _t(t.slice(u, i)), i < o && _t(t = t.slice(i)), i < o && pt(t))
                        }
                        h.push(n)
                    }
                return gt(h)
            ...
            a = rt.tokenize = function(t, e) {
                ...
                return e ? s.length : s ? rt.error(t) : C(t, u).slice(0)
            }
            ,
                    ...
                    (s = S(t, function(t, e) {
                        var n = e.length > 0
                          ...
                          , o = function(o, a, s, u, c) {
                            var f, p, g, m = 0, y = "0", _ = o && [], b = [], w = l, E = o || i && r.find.TAG("*", c), T = x += null == w ? 1 : Math.random() || .1, C = E.length;
                            ...
                            n && y !== m) {
                                ...
                                if (o) {
                                    if (m > 0)
                                        for (; y--; )
                                            _[y] || b[y] || (b[y] = j.call(u));
                                    b = mt(b)
                                }
                                O.apply(u, b),
                                c && !o && b.length > 0 && m + e.length > 1 && rt.uniqueSort(u)
                            }
                            return c && (x = T,
                            l = w),
                            _
            ...
            u = rt.select = function(t, e, i, o) {
                var u, l, c, f, h, d = "function" == typeof t && t, p = !o && a(t = d.selector || t);
                if (i = i || [],
                1 === p.length) {
                    if ((l = p[0] = p[0].slice(0)).length > 2 && "ID" === (c = l[0]).type && n.getById && 9 === e.nodeType && v && r.relative[l[1].type]) {
                        if (!(e = (r.find.ID(c.matches[0].replace(tt, et), e) || [])[0]))
                            return i;
                        d && (e = e.parentNode),
                        t = t.slice(l.shift().value.length)
                    }
                    for (u = V.needsContext.test(t) ? 0 : l.length; u-- && (c = l[u],
                    !r.relative[f = c.type]); )
                        if ((h = r.find[f]) && (o = h(c.matches[0].replace(tt, et), J.test(l[0].type) && ht(e.parentNode) || e))) {
                            if (l.splice(u, 1),
                            !(t = o.length && pt(l)))
                                return O.apply(i, o),
                                i;
                ...
                return (d || s(t, p))(o, e, !v, i, !e || J.test(t) && ht(e.parentNode) || e),
                i
            }
            ,
        ...
        v.fn.extend({
            find: function(t) {
                ...
                for (e = 0; e < n; e++)
                    v.find(t, i[e], r);
                return (r = this.pushStack(n > 1 ? v.unique(r) : r)).selector = this.selector ? this.selector + " " + t : t,
                r
            },
            filter: function(t) {
            ...
            is: function(t) {
                return !!k(this, "string" == typeof t && T.test(t) ? v(t) : t || [], !1).length
            }
        });
        var A, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
        (v.fn.init = function(t, e, n) {
            ...
            "string" == typeof t) {
                ...
                return (i = a.getElementById(r[2])) && i.parentNode && (this.length = 1,
                this[0] = i),
                this.context = a,
                this.selector = t,
                this
        ...
        v.fn.extend({
            ...
            closest: function(t, e) {
                for (var n, r = 0, i = this.length, o = [], a = T.test(t) || "string" != typeof t ? v(t, e || this.context) : 0; r < i; r++)
            ...
            index: function(t) {
                return t ? "string" == typeof t ? c.call(v(t), this[0]) : c.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
            },
            add: function(t, e) {
        ...
        v.each({
            ...
            v.fn[t] = function(n, r) {
                ...
                this.length > 1 && (D[t] || v.uniqueSort(i),
                j.test(t) && i.reverse()),
                this.pushStack(i)
            }
        }
        ...
        v.Callbacks = function(t) {
            t = "string" == typeof t ? function(t) {
                var e = {};
                return v.each(t.match(L) || [], (function(t, n) {
                    e[n] = !0
                }
                )),
                e
        ...
        v.extend({
            ...
            when: function(t) {
                var e, n, r, i = 0, o = s.call(arguments), a = o.length, u = 1 !== a || t && v.isFunction(t.promise) ? a : 0, l = 1 === u ? t : v.Deferred(), c = function(t, n, r) {
                    return function(i) {
                        n[t] = this,
                        r[t] = arguments.length > 1 ? s.call(arguments) : i,
                        r === e ? l.notifyWith(n, r) : --u || l.resolveWith(n, r)
                    }
                };
                if (a > 1)
                    for (e = new Array(a),
                    n = new Array(a),
                    r = new Array(a); i < a; i++)
                        o[i] && v.isFunction(o[i].promise) ? o[i].promise().progress(c(i, n, e)).done(c(i, r, o)).fail(l.reject) : --u;
        ...
        v.extend({
            ...
            ready: function(t) {
                ...
                !0 !== t && --v.readyWait > 0 || (I.resolveWith(a, [v]),
                v.fn.triggerHandler && (v(a).triggerHandler("ready"),
                v(a).off("ready"))))
            }
        }),
        v.ready.promise = function(t) {
            return I || (I = v.Deferred(),
            "complete" === a.readyState || "loading" !== a.readyState && !a.documentElement.doScroll ? n.setTimeout(v.ready) : (a.addEventListener("DOMContentLoaded", R),
        ...
        F.prototype = {
            ...
            access: function(t, e, n) {
                var r;
                return void 0 === e || e && "string" == typeof e && void 0 === n ? void 0 !== (r = this.get(t, e)) ? r : this.get(t, v.camelCase(e)) : (this.set(t, e, n),
                void 0 !== n ? n : e)
            },
            remove: function(t, e) {
                ...
                if (void 0 !== o) {
                    if (void 0 === e)
                        ...
                        v.isArray(e) ? r = e.concat(e.map(v.camelCase)) : (i = v.camelCase(e),
                        r = e in o ? [e, i] : (r = i)in o ? [r] : r.match(L) || []),
                        n = r.length;
                        for (; n--; )
                            delete o[r[n]]
                    }
        ...
        function z(t, e, n) {
            ...
            if (void 0 === n && 1 === t.nodeType)
                if (r = "data-" + e.replace(W, "-$&").toLowerCase(),
            ...
            data: function(t, e) {
                ...
                if (void 0 === t) {
                    ...
                    1 === o.nodeType && !H.get(o, "hasDataAttrs"))) {
                        for (n = a.length; n--; )
                            a[n] && 0 === (r = a[n].name).indexOf("data-") && (r = v.camelCase(r.slice(5)),
                            z(o, r, i[r]));
                ...
                return "object" == typeof t ? this.each((function() {
                    ...
                    var n, r;
                    if (o && void 0 === e)
                        return void 0 !== (n = M.get(o, t) || M.get(o, t.replace(W, "-$&").toLowerCase())) ? n : (r = v.camelCase(t),
                        void 0 !== (n = M.get(o, r)) || void 0 !== (n = z(o, r, void 0)) ? n : void 0);
                    r = v.camelCase(t),
                    this.each((function() {
                        var n = M.get(this, r);
                        M.set(this, r, e),
                        t.indexOf("-") > -1 && void 0 !== n && M.set(this, t, e)
                    }
                    ))
                }
        ...
        v.extend({
            queue: function(t, e, n) {
                ...
                if (t)
                    return e = (e || "fx") + "queue",
                    r = H.get(t, e),
                    n && (!r || v.isArray(n) ? r = H.access(t, e, v.makeArray(n)) : r.push(n)),
                    r || []
            },
        ...
        v.fn.extend({
            ...
            promise: function(t, e) {
                ...
                t = void 0),
                t = t || "fx"; a--; )
                    (n = H.get(o[a], t + "queueHooks")) && n.empty && (r++,
                    n.empty.add(s));
                return s(),
                i.promise(e)
            }
        ...
        function X(t, e, n, r) {
            ...
            , u = s(), l = n && n[3] || (v.cssNumber[e] ? "" : "px"), c = (v.cssNumber[e] || "px" !== l && +u) && $.exec(v.css(t, e));
            if (c && c[3] !== l) {
                l = l || c[3],
                n = n || [],
                c = +u || 1;
        ...
        function it(t, e, n, r, i) {
            ...
            for (f.textContent = "",
            d = 0; o = h[d++]; )
                if (r && v.inArray(o, r) > -1)
                    i && i.push(o);
                else if (l = v.contains(o.ownerDocument, o),
        ...
        v.event = {
            ...
            add: function(t, e, n, r, i) {
                var o, a, s, u, l, c, f, h, d, p, g, m = H.get(t);
                if (m)
                    ...
                    l = (e = (e || "").match(L) || [""]).length; l--; )
                        ...
                        f.setup && !1 !== f.setup.call(t, r, p, a) || t.addEventListener && t.addEventListener(d, a)),
            ...
            remove: function(t, e, n, r, i) {
                var o, a, s, u, l, c, f, h, d, p, g, m = H.hasData(t) && H.get(t);
                if (m && (u = m.events)) {
                    for (l = (e = (e || "").match(L) || [""]).length; l--; )
                        if (d = g = (s = st.exec(e[l]) || [])[1],
                        p = (s[2] || "").split(".").sort(),
                        d) {
                            ...
                            a = o = h.length; o--; )
                                c = h[o],
                                !i && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (h.splice(o, 1),
                                c.selector && h.delegateCount--,
                                f.remove && f.remove.call(t, c));
                            a && !h.length && (f.teardown && !1 !== f.teardown.call(t, p, m.handle) || v.removeEvent(t, d, m.handle),
                            delete u[d])
                        } else
                            for (d in u)
            ...
            dispatch: function(t) {
                t = v.event.fix(t);
                var e, n, r, i, o, a = [], u = s.call(arguments), l = (H.get(this, "events") || {})[t.type] || [], c = v.event.special[t.type] || {};
                if (u[0] = t,
                t.delegateTarget = this,
                !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                    for (a = v.event.handlers.call(this, t, l),
            ...
            mouseHooks: {
                ...
                filter: function(t, e) {
                    ...
                    return null == t.pageX && null != e.clientX && (r = (n = t.target.ownerDocument || a).documentElement,
                    i = n.body,
            ...
            fix: function(t) {
                ...
                for (s || (this.fixHooks[i] = s = at.test(i) ? this.mouseHooks : ot.test(i) ? this.keyHooks : {}),
        ...
        v.Event = function(t, e) {
            ...
            this.type = t.type,
            this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? ut : lt) : this.type = t,
            e && v.extend(this, e),
        ...
        function wt(t, e, n, r) {
            e = u.apply([], e);
            var i, o, a, s, l, c, f = 0, h = t.length, d = h - 1, g = e[0], m = v.isFunction(g);
            if (m || h > 1 && "string" == typeof g && !p.checkClone && pt.test(g))
            ...
            if (h && (o = (i = it(e, t[0].ownerDocument, !1, t, r)).firstChild,
            1 === i.childNodes.length && (i = o),
            o || r)) {
                for (s = (a = v.map(Z(i, "script"), yt)).length; f < h; f++)
                    l = i,
                    f !== d && (l = v.clone(l, !0, !0),
                ...
                if (s)
                    ...
                    f = 0; f < s; f++)
                        l = a[f],
                        G.test(l.type || "") && !H.access(l, "globalEval") && v.contains(c, l) && (l.src ? v._evalUrl && v._evalUrl(l.src) : v.globalEval(l.textContent.replace(gt, "")))
            }
            return t
        }
        function xt(t, e, n) {
            for (var r, i = e ? v.filter(e, t) : t, o = 0; null != (r = i[o]); o++)
                ...
                r.parentNode && (n && v.contains(r.ownerDocument, r) && tt(Z(r, "script")),
        ...
        v.extend({
            ...
            clone: function(t, e, n) {
                var r, i, o, a, s, u, l, c = t.cloneNode(!0), f = v.contains(t.ownerDocument, t);
                if (!(p.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || v.isXMLDoc(t)))
                    for (a = Z(c),
                    r = 0,
                    i = (o = Z(t)).length; r < i; r++)
                        s = o[r],
                        u = a[r],
                        l = void 0,
                ...
                if (e)
                    if (n)
                        ...
                        bt(t, c);
                return (a = Z(c, "script")).length > 0 && tt(a, !f && Z(t, "script")),
                c
            },
                ...
                for (var e, n, r, i = v.event.special, o = 0; void 0 !== (n = t[o]); o++)
                    if (q(n)) {
                        if (e = n[H.expando]) {
                            if (e.events)
                                for (r in e.events)
                                    i[r] ? v.event.remove(n, r) : v.removeEvent(n, r, e.handle);
                            n[H.expando] = void 0
                        }
        ...
        v.fn.extend({
            ...
            empty: function() {
                for (var t, e = 0; null != (t = this[e]); e++)
                    1 === t.nodeType && (v.cleanData(Z(t, !1)),
                    t.textContent = "");
                return this
            },
            clone: function(t, e) {
            ...
            html: function(t) {
                return P(this, (function(t) {
                    ...
                    if (void 0 === t && 1 === e.nodeType)
                        return e.innerHTML;
                    if ("string" == typeof t && !dt.test(t) && !J[(K.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = v.htmlPrefilter(t);
                        try {
                            for (; n < r; n++)
                                1 === (e = this[n] || {}).nodeType && (v.cleanData(Z(e, !1)),
                                e.innerHTML = t);
                            e = 0
                        } catch (t) {}
                    }
            ...
            replaceWith: function() {
                ...
                return wt(this, arguments, (function(e) {
                    ...
                    v.inArray(this, t) < 0 && (v.cleanData(Z(this)),
        ...
        v.each({
            ...
            v.fn[t] = function(t) {
                for (var n, r = [], i = v(t), o = i.length - 1, a = 0; a <= o; a++)
        ...
        function St(t) {
            var e = a
              , n = Tt[t];
            return n || ("none" !== (n = Ct(t, e)) && n || ((e = (Et = (Et || v("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement))[0].contentDocument).write(),
            e.close(),
            n = Ct(t, e),
            Et.detach()),
            Tt[t] = n),
        ...
        function Ot(t, e, n) {
            ...
            return "" !== (a = (n = n || Nt(t)) ? n.getPropertyValue(e) || n[e] : void 0) && void 0 !== a || v.contains(t.ownerDocument, t) || (a = v.style(t, e)),
            n && !p.pixelMarginRight() && At.test(a) && kt.test(e) && (r = s.width,
            i = s.minWidth,
            o = s.maxWidth,
        ...
        !function() {
            var t, e, r, i, o = a.createElement("div"), s = a.createElement("div");
            function u() {
        ...
        function Bt(t, e, n, r, i) {
            for (var o = n === (r ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; o < 4; o += 2)
                ...
                r ? ("content" === n && (a -= v.css(t, "padding" + Q[o], !0, i)),
                "margin" !== n && (a -= v.css(t, "border" + Q[o] + "Width", !0, i))) : (a += v.css(t, "padding" + Q[o], !0, i),
                "padding" !== n && (a += v.css(t, "border" + Q[o] + "Width", !0, i)));
            return a
        }
        function Wt(t, e, n) {
            var r = !0
            ...
            if (i <= 0 || null == i) {
                if (((i = Ot(t, e, o)) < 0 || null == i) && (i = t.style[e]),
                At.test(i))
                    return i;
                r = a && (p.boxSizingReliable() || i === t.style[e]),
                i = parseFloat(i) || 0
            }
            return i + Bt(t, e, n || (a ? "border" : "content"), r, o) + "px"
        }
        function zt(t, e) {
            for (var n, r, i, o = [], a = 0, s = t.length; a < s; a++)
                (r = t[a]).style && (o[a] = H.get(r, "olddisplay"),
                n = r.style.display,
                e ? (o[a] || "none" !== n || (r.style.display = ""),
                "" === r.style.display && V(r) && (o[a] = H.access(r, "olddisplay", St(r.nodeName)))) : (i = V(r),
                "none" === n && i || H.set(r, "olddisplay", i ? n : v.css(r, "display"))));
            for (a = 0; a < s; a++)
        ...
        v.extend({
            ...
            style: function(t, e, n, r) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    if (e = v.cssProps[s] || (v.cssProps[s] = Ht(s) || s),
                    a = v.cssHooks[e] || v.cssHooks[s],
                    void 0 === n)
                        return a && "get"in a && void 0 !== (i = a.get(t, !1, r)) ? i : u[e];
                    "string" == (o = typeof n) && (i = $.exec(n)) && i[1] && (n = X(t, e, i),
                    o = "number"),
            ...
            css: function(t, e, n, r) {
                ...
                return e = v.cssProps[s] || (v.cssProps[s] = Ht(s) || s),
                (a = v.cssHooks[e] || v.cssHooks[s]) && "get"in a && (i = a.get(t, !0, n)),
                void 0 === i && (i = Ot(t, e, r)),
        ...
        v.each(["height", "width"], (function(t, e) {
            v.cssHooks[e] = {
                get: function(t, n, r) {
                    if (n)
                        return Lt.test(v.css(t, "display")) && 0 === t.offsetWidth ? jt(t, Rt, (function() {
                            return Wt(t, e, r)
                        }
                        )) : Wt(t, e, r)
                },
                set: function(t, n, r) {
                    var i, o = r && Nt(t), a = r && Bt(t, e, r, "border-box" === v.css(t, "boxSizing", !1, o), o);
                    return a && (i = $.exec(n)) && "px" !== (i[3] || "px") && (t.style[e] = n,
                    n = v.css(t, e)),
                    Mt(0, n, a)
                }
            }
        ...
        v.cssHooks.marginLeft = It(p.reliableMarginLeft, (function(t, e) {
            if (e)
                return (parseFloat(Ot(t, "marginLeft")) || t.getBoundingClientRect().left - jt(t, {
                    marginLeft: 0
                }, (function() {
        ...
        v.cssHooks.marginRight = It(p.reliableMarginRight, (function(t, e) {
            if (e)
                return jt(t, {
        ...
        v.fx.step = {};
        var $t, Qt, Vt = /^(?:toggle|show|hide)$/, Xt = /queueHooks$/;
        function Yt() {
        ...
        function Jt(t, e, n) {
            var r, i, o = 0, a = Jt.prefilters.length, s = v.Deferred().always((function() {
                delete u.elem
            }
            )), u = function() {
                if (i)
                    return !1;
                for (var e = $t || Yt(), n = Math.max(0, l.startTime + l.duration - e), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++)
                    l.tweens[o].run(r);
                return s.notifyWith(t, [l, r, n]),
                r < 1 && a ? n : (s.resolveWith(t, [l]),
                !1)
            }, l = s.promise({
                elem: t,
                props: v.extend({}, e),
            ...
            for (function(t, e) {
                ...
                if (r = Jt.prefilters[o].call(l, t, c, l.opts))
                    return v.isFunction(r.stop) && (v._queueHooks(l.elem, l.opts.queue).stop = v.proxy(r.stop, r)),
                    r;
            return v.map(c, Gt, l),
        ...
        v.Animation = v.extend(Jt, {
            ...
            prefilters: [function(t, e, n) {
                var r, i, o, a, s, u, l, c = this, f = {}, h = t.style, d = t.nodeType && V(t), p = H.get(t, "fxshow");
                ...
                "inline" === ("none" === (l = v.css(t, "display")) ? H.get(t, "olddisplay") || St(t.nodeName) : l) && "none" === v.css(t, "float") && (h.display = "inline-block")),
                ...
                if (v.isEmptyObject(f))
                    "inline" === ("none" === l ? St(t.nodeName) : l) && (h.display = l);
                else
                    for (r in p ? "hidden"in p && (d = p.hidden) : p = H.access(t, "fxshow", {}),
                    o && (p.hidden = !d),
                    d ? v(t).show() : c.done((function() {
                        v(t).hide()
                    }
                    )),
                    c.done((function() {
        ...
        v.fn.extend({
            ...
            finish: function(t) {
                return !1 !== t && (t = t || "fx"),
                this.each((function() {
                    var e, n = H.get(this), r = n[t + "queue"], i = n[t + "queueHooks"], o = v.timers, a = r ? r.length : 0;
                    for (n.finish = !0,
                    v.queue(this, t, []),
        ...
        v.extend({
            attr: function(t, e, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    ...
                    i = v.attrHooks[e] || (v.expr.match.bool.test(e) ? Zt : void 0)),
            ...
            removeAttr: function(t, e) {
                var n, r, i = 0, o = e && e.match(L);
                if (o && 1 === t.nodeType)
                    for (; n = o[i++]; )
                        r = v.propFix[n] || n,
                        v.expr.match.bool.test(n) && (t[r] = !1),
                        t.removeAttribute(n)
            }
        }),
        Zt = {
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : v.isFunction(t) ? this.each((function(n) {
                    ...
                    if ("string" === n)
                        ...
                        void 0 !== t && "boolean" !== n || ((e = ie(this)) && H.set(this, "__className__", e),
                        this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : H.get(this, "__className__") || ""))
                }
                ))
            },
            hasClass: function(t) {
                var e, n, r = 0;
                for (e = " " + t + " "; n = this[r++]; )
                    if (1 === n.nodeType && (" " + ie(n) + " ").replace(re, " ").indexOf(e) > -1)
                        return !0;
                return !1
            }
        });
                ...
                select: {
                    ...
                    set: function(t, e) {
                        for (var n, r, i = t.options, o = v.makeArray(e), a = i.length; a--; )
                            ((r = i[a]).selected = v.inArray(v.valHooks.option.get(r), o) > -1) && (n = !0);
        ...
        v.extend(v.event, {
            trigger: function(t, e, r, i) {
                var o, s, u, l, c, f, h, p = [r || a], g = d.call(t, "type") ? t.type : t, m = d.call(t, "namespace") ? t.namespace.split(".") : [];
                if (s = u = r = r || a,
                3 !== r.nodeType && 8 !== r.nodeType && !se.test(g + v.event.triggered) && (g.indexOf(".") > -1 && (m = g.split("."),
                g = m.shift(),
                m.sort()),
                c = g.indexOf(":") < 0 && "on" + g,
                ...
                i || !h.trigger || !1 !== h.trigger.apply(r, e))) {
                    if (!i && !h.noBubble && !v.isWindow(r)) {
                        ...
                        se.test(l + g) || (s = s.parentNode); s; s = s.parentNode)
                            p.push(s),
                            u = s;
                        u === (r.ownerDocument || a) && p.push(u.defaultView || u.parentWindow || n)
                    }
                    for (o = 0; (s = p[o++]) && !t.isPropagationStopped(); )
                        t.type = o > 1 ? l : h.bindType || g,
                        (f = (H.get(s, "events") || {})[t.type] && H.get(s, "handle")) && f.apply(s, e),
                        (f = c && s[c]) && f.apply && q(s) && (t.result = f.apply(s, e),
                        !1 === t.result && t.preventDefault());
                    return t.type = g,
                    i || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(p.pop(), e) || !q(r) || c && v.isFunction(r[g]) && !v.isWindow(r) && ((u = r[c]) && (r[c] = null),
                    v.event.triggered = g,
                    r[g](),
        ...
        p.focusin || v.each({
            ...
            v.event.special[e] = {
                ...
                teardown: function() {
                    var r = this.ownerDocument || this
                      , i = H.access(r, e) - 1;
                    i ? H.access(r, e, i) : (r.removeEventListener(t, n, !0),
                    H.remove(r, e))
                }
            }
        }
        ...
        v.parseXML = function(t) {
            ...
            return e && !e.getElementsByTagName("parsererror").length || v.error("Invalid XML: " + t),
            e
        }
        ;
        var fe = /#.*$/
        ...
        v.extend({
            ...
            ajax: function(t, e) {
                ...
                t = void 0),
                e = e || {};
                var r, i, o, s, u, l, c, f, h = v.ajaxSetup({}, e), d = h.context || h, p = h.context && (d.nodeType || d.jquery) ? v(d) : v.event, g = v.Deferred(), m = v.Callbacks("once memory"), y = h.statusCode || {}, _ = {}, b = {}, w = 0, x = "canceled", E = {
                    readyState: 0,
                ...
                if (g.promise(E).complete = m.add,
                E.success = E.done,
                E.error = E.fail,
                h.url = ((t || h.url || ue.href) + "").replace(fe, "").replace(ve, ue.protocol + "//"),
                h.type = e.method || e.type || h.method || h.type,
                h.dataTypes = v.trim(h.dataType || "*").toLowerCase().match(L) || [""],
                null == h.crossDomain) {
                    l = a.createElement("a");
                    try {
                        l.href = h.url,
                        l.href = l.href,
                        h.crossDomain = _e.protocol + "//" + _e.host != l.protocol + "//" + l.host
                    } catch (t) {
                        h.crossDomain = !0
                    }
                }
                ...
                2 === w)
                    return E;
                for (f in (c = v.event && h.global) && 0 == v.active++ && v.event.trigger("ajaxStart"),
                h.type = h.type.toUpperCase(),
                h.hasContent = !pe.test(h.type),
                i = h.url,
                h.hasContent || (h.data && (i = h.url += (ce.test(i) ? "&" : "?") + h.data,
                delete h.data),
                !1 === h.cache && (h.url = he.test(i) ? i.replace(he, "$1_=" + le++) : i + (ce.test(i) ? "&" : "?") + "_=" + le++)),
                h.ifModified && (v.lastModified[i] && E.setRequestHeader("If-Modified-Since", v.lastModified[i]),
                v.etag[i] && E.setRequestHeader("If-None-Match", v.etag[i])),
                (h.data && h.hasContent && !1 !== h.contentType || e.contentType) && E.setRequestHeader("Content-Type", h.contentType),
                E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + ye + "; q=0.01" : "") : h.accepts["*"]),
                h.headers)
                    E.setRequestHeader(f, h.headers[f]);
                if (h.beforeSend && (!1 === h.beforeSend.call(d, E, h) || 2 === w))
                    return E.abort();
                for (f in x = "abort",
                {
                    success: 1,
                ...
                function T(t, e, a, s) {
                    ...
                    l ? (h.ifModified && ((x = E.getResponseHeader("Last-Modified")) && (v.lastModified[i] = x),
                    (x = E.getResponseHeader("etag")) && (v.etag[i] = x)),
                    ...
                    E.status = t,
                    E.statusText = (e || T) + "",
                    l ? g.resolveWith(d, [f, T, E]) : g.rejectWith(d, [E, T, _]),
                    E.statusCode(y),
                    y = void 0,
                    c && p.trigger(l ? "ajaxSuccess" : "ajaxError", [E, h, l ? f : _]),
                    m.fireWith(d, [E, T]),
                    c && (p.trigger("ajaxComplete", [E, h]),
        ...
        v.fn.extend({
            wrapAll: function(t) {
                ...
                )) : (this[0] && (e = v(t, this[0].ownerDocument).eq(0).clone(!0),
        ...
        v.fn.extend({
            ...
            serializeArray: function() {
                return this.map((function() {
                    ...
                    var t = this.type;
                    return this.name && !v(this).is(":disabled") && ke.test(this.nodeName) && !Se.test(t) && (this.checked || !Y.test(t))
                }
                )).map((function(t, e) {
                    var n = v(this).val();
            ...
            if (p.cors || je && !t.crossDomain)
                return {
                    send: function(i, o) {
                        ...
                        e = function(t) {
                            return function() {
                                e && (e = r = s.onload = s.onerror = s.onabort = s.onreadystatechange = null,
                                "abort" === t ? s.abort() : "error" === t ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Ne[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                    binary: s.response
                                } : {
                                    text: s.responseText
        ...
        v.ajaxPrefilter("json jsonp", (function(t, e, r) {
            var i, o, a, s = !1 !== t.jsonp && (Oe.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Oe.test(t.data) && "data");
            if (s || "jsonp" === t.dataTypes[0])
                return i = t.jsonpCallback = v.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                s ? t[s] = t[s].replace(Oe, "$1" + i) : !1 !== t.jsonp && (t.url += (ce.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        ...
        v.parseHTML = function(t, e, n) {
            ...
            var r = C.exec(t)
              , i = !n && [];
            return r ? [e.createElement(r[1])] : (r = it([t], e, i),
        ...
        v.offset = {
            setOffset: function(t, e, n) {
                var r, i, o, a, s, u, l = v.css(t, "position"), c = v(t), f = {};
        ...
        v.fn.extend({
            offset: function(t) {
                ...
                v.contains(e, r) ? (i = r.getBoundingClientRect(),
                n = Le(o),
                {
            ...
            position: function() {
                if (this[0]) {
                    ...
                    e = this.offset(),
                    v.nodeName(t[0], "html") || (r = t.offset()),
                    r.top += v.css(t[0], "borderTopWidth", !0),
                    r.left += v.css(t[0], "borderLeftWidth", !0)),
                    {
    ...
    (function(t, r) {
        ...
        (function() {
            var o = "Expected a function"
              ...
              , Rt = RegExp([Ct + "?" + _t + "+(?:['’](?:d|ll|m|re|s|t|ve))?(?=" + [vt, Ct, "$"].join("|") + ")", kt + "+(?:['’](?:D|LL|M|RE|S|T|VE))?(?=" + [vt, Ct + St, "$"].join("|") + ")", Ct + "?" + St + "+(?:['’](?:d|ll|m|re|s|t|ve))?", Ct + "+(?:['’](?:D|LL|M|RE|S|T|VE))?", "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", mt, jt].join("|"), "g")
              , Pt = RegExp("[\\u200d\\ud800-\\udfff" + ht + "\\ufe0e\\ufe0f]")
              ...
              , Ht = -1
              , Mt = {};
            Mt[C] = Mt[S] = Mt[k] = Mt[A] = Mt[N] = Mt[j] = Mt["[object Uint8ClampedArray]"] = Mt[D] = Mt[O] = !0,
            Mt[u] = Mt[l] = Mt[E] = Mt[c] = Mt[T] = Mt[f] = Mt[h] = Mt[d] = Mt[v] = Mt[g] = Mt[m] = Mt[y] = Mt[_] = Mt[b] = Mt[x] = !1;
            var Bt = {};
            Bt[u] = Bt[l] = Bt[E] = Bt[T] = Bt[c] = Bt[f] = Bt[C] = Bt[S] = Bt[k] = Bt[A] = Bt[N] = Bt[v] = Bt[g] = Bt[m] = Bt[y] = Bt[_] = Bt[b] = Bt[w] = Bt[j] = Bt["[object Uint8ClampedArray]"] = Bt[D] = Bt[O] = !0,
            Bt[h] = Bt[d] = Bt[x] = !1;
            var Wt = {
                "\\": "\\",
                "'": "'",
            ...
            var Ke = function t(e) {
                var n, r = (e = null == e ? Vt : Ke.defaults(Vt.Object(), e, Ke.pick(Vt, Ft))).Array, i = e.Date, Y = e.Error, ht = e.Function, dt = e.Math, pt = e.Object, vt = e.RegExp, gt = e.String, mt = e.TypeError, yt = r.prototype, _t = ht.prototype, bt = pt.prototype, wt = e["__core-js_shared__"], xt = _t.toString, Et = bt.hasOwnProperty, Tt = 0, Ct = (n = /[^.]+$/.exec(wt && wt.keys && wt.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "", St = bt.toString, kt = xt.call(pt), At = Vt._, Nt = vt("^" + xt.call(Et).replace(Q, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), jt = Kt ? e.Buffer : void 0, Dt = e.Symbol, Lt = e.Uint8Array, Pt = jt ? jt.allocUnsafe : void 0, Wt = We(pt.getPrototypeOf, pt), $t = pt.create, Qt = bt.propertyIsEnumerable, Xt = yt.splice, Yt = Dt ? Dt.isConcatSpreadable : void 0, Gt = Dt ? Dt.iterator : void 0, Jt = Dt ? Dt.toStringTag : void 0, ye = function() {
                    try {
                        var t = to(pt, "defineProperty");
                        return t({}, "", {}),
                        t
                    } catch (t) {}
                }(), Se = e.clearTimeout !== Vt.clearTimeout && e.clearTimeout, Ge = i && i.now !== Vt.Date.now && i.now, Je = e.setTimeout !== Vt.setTimeout && e.setTimeout, Ze = dt.ceil, tn = dt.floor, en = pt.getOwnPropertySymbols, nn = jt ? jt.isBuffer : void 0, rn = e.isFinite, on = yt.join, an = We(pt.keys, pt), sn = dt.max, un = dt.min, ln = i.now, cn = e.parseInt, fn = dt.random, hn = yt.reverse, dn = to(e, "DataView"), pn = to(e, "Map"), vn = to(e, "Promise"), gn = to(e, "Set"), mn = to(e, "WeakMap"), yn = to(pt, "create"), _n = mn && new mn, bn = {}, wn = Ao(dn), xn = Ao(pn), En = Ao(vn), Tn = Ao(gn), Cn = Ao(mn), Sn = Dt ? Dt.prototype : void 0, kn = Sn ? Sn.valueOf : void 0, An = Sn ? Sn.toString : void 0;
                function Nn(t) {
                ...
                function Hn(t, e) {
                    var n = La(t)
                      ...
                      , u = s.length;
                    for (var l in t)
                        !e && !Et.call(t, l) || a && ("length" == l || i && ("offset" == l || "parent" == l) || o && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || so(l, u)) || s.push(l);
                    return s
                }
                function Mn(t) {
                    var e = t.length;
                ...
                function zn(t, e, n) {
                    (void 0 !== n && !ja(t[e], n) || void 0 === n && !(e in t)) && Xn(t, e, n)
                }
                function Un(t, e, n) {
                    var r = t[e];
                    Et.call(t, e) && ja(r, n) && (void 0 !== n || e in t) || Xn(t, e, n)
                }
                function $n(t, e) {
                ...
                function Gn(t, e, n, r, i, o) {
                    ...
                    var P = x ? void 0 : (h ? l ? Vi : Qi : l ? xs : ws)(t);
                ...
                function yr(t, e, n) {
                    for (var i = n ? he : fe, o = t[0].length, a = t.length, s = a, u = r(a), l = 1 / 0, c = []; s--; ) {
                        ...
                        s && e && (f = de(f, De(e))),
                        l = un(f.length, l),
                        u[s] = !n && (e || o >= 120 && f.length >= 120) ? new qn(s && f) : void 0
                    }
                    f = t[0];
                    var h = -1
                      , d = u[0];
                ...
                function _r(t, e, n) {
                    var r = null == (t = mo(t, e = ui(e, t))) ? t : t[ko(Mo(e))];
                ...
                function wr(t, e, n, r, i) {
                    return t === e || (null == t || null == e || !$a(t) && !$a(e) ? t != t && e != e : function(t, e, n, r, i, o) {
                        var a = La(t)
                          , s = La(e)
                          , d = a ? l : ro(t)
                          , p = s ? l : ro(e)
                        ...
                        if (S && !x)
                            return o || (o = new Fn),
                            a || Za(t) ? Ui(t, e, n, r, i, o) : function(t, e, n, r, i, o, a) {
                                switch (n) {
                                case T:
                        ...
                        function(t, e, n, r, i, o) {
                            ...
                            for (; ++c < u; ) {
                                ...
                                var g = t[f]
                                  , m = e[f];
                                if (r)
                                    var y = a ? r(m, g, f, e, t, o) : r(g, m, f, t, e, o);
                ...
                function Er(t) {
                    return !(!Ua(t) || (e = t,
                    Ct && Ct in e)) && (Ba(t) ? Nt : at).test(Ao(t));
                    var e
                }
                function Tr(t) {
                    return "function" == typeof t ? t : null == t ? Vs : "object" == typeof t ? La(t) ? jr(t[0], t[1]) : Nr(t) : nu(t)
                }
                function Cr(t) {
                    if (!ho(t))
                        return an(t);
                ...
                function jr(t, e) {
                    return lo(t) && po(e) ? vo(ko(t), e) : function(n) {
                        var r = gs(n, t);
                            ...
                            !function(t, e, n, r, i, o, a) {
                                ...
                                if (f) {
                                    var h = La(u)
                                      ...
                                      , p = !h && !d && Za(u);
                                    c = u,
                                    h || d || p ? La(s) ? c = s : qa(s) ? c = yi(s) : d ? (f = !1,
                                    c = hi(u, !0)) : p ? (f = !1,
                                    c = pi(u, !0)) : c = [] : Xa(u) || Ia(u) ? (c = s,
                                    Ia(s) ? c = ss(s) : Ua(s) && !Ba(s) || (c = oo(u))) : f = !1
                                }
                                f && (a.set(u, c),
                                i(c, u, r, o, a),
                                a.delete(u));
                ...
                function Wr(t, e, n, r) {
                    ...
                    for (var i = -1, o = (e = ui(e, t)).length, a = o - 1, s = t; null != s && ++i < o; ) {
                        ...
                        if (i != a) {
                            var c = s[u];
                            void 0 === (l = r ? r(c, u, s) : void 0) && (l = Ua(c) ? c : so(e[i + 1]) ? [] : {})
                        }
                        Un(s, u, l),
                        s = s[u]
                    }
                ...
                function Yr(t, e, n, r) {
                    ...
                    for (var a = (e = n(e)) != e, s = null === e, u = Ja(e), l = void 0 === e; i < o; ) {
                        ...
                        if (a)
                            ...
                            g = l ? p && (r || h) : s ? p && h && (r || !d) : u ? p && h && !d && (r || !v) : !d && !v && (r ? f <= e : f < e);
                        g ? i = c + 1 : o = c
                    }
                ...
                function ti(t, e) {
                    return null == (t = mo(t, e = ui(e, t))) || delete t[ko(Mo(e))]
                }
                function ei(t, e, n, r) {
                ...
                function gi(t, e, n, i) {
                    for (var o = -1, a = t.length, s = n.length, u = -1, l = e.length, c = sn(a - s, 0), f = r(l + c), h = !i; ++u < l; )
                        f[u] = e[u];
                    for (; ++o < s; )
                        (h || o < a) && (f[n[o]] = t[o]);
                    for (; c--; )
                ...
                function mi(t, e, n, i) {
                    for (var o = -1, a = t.length, s = -1, u = n.length, l = -1, c = e.length, f = sn(a - u, 0), h = r(f + c), d = !i; ++o < f; )
                        h[o] = t[o];
                    for (var p = o; ++l < c; )
                        h[p + l] = e[l];
                    for (; ++s < u; )
                ...
                function Ai(t) {
                    return $i((function(e) {
                        ...
                        for (r = s ? r : n; ++r < n; ) {
                            ...
                            s = l && co(l[0]) && 424 == l[1] && !l[4].length && 1 == l[9] ? s[Yi(l[0])].apply(s, l[3]) : 1 == a.length && co(a) ? s[u]() : s.thru(a)
                        }
                        return function() {
                            var t = arguments
                              , r = t[0];
                ...
                function Ni(t, e, n, i, o, a, s, u, l, c) {
                    ...
                    return function m() {
                        ...
                        p && y < c) {
                            var E = ze(_, w);
                            return Pi(t, e, Ni, m.placeholder, n, _, E, u, l, c - y)
                        }
                        var T = h ? n : this
                          , C = d ? T[t] : t;
                        return y = _.length,
                        ...
                        f && l < y && (_.length = l),
                        this && this !== Vt && this instanceof m && (C = g || Si(C)),
                        C.apply(T, _)
                    }
                }
                function ji(t, e) {
                ...
                function Li(t) {
                    return function(e, n, i) {
                        ...
                        e = 0) : n = rs(n),
                        function(t, e, n, i) {
                            for (var o = -1, a = sn(Ze((e - t) / (n || 1)), 0), s = r(a); a--; )
                                s[i ? a : ++o] = t,
                                t += n;
                            return s
                ...
                var Fi = gn && 1 / Ue(new gn([, -0]))[1] == 1 / 0 ? function(t) {
                    return new gn(t)
                }
                : Js;
                function Hi(t) {
                    return function(e) {
                        var n = ro(e);
                        return n == v ? Be(e) : n == _ ? $e(e) : function(t, e) {
                            return de(e, (function(e) {
                                return [e, t[e]]
                            }
                            ))
                ...
                function Mi(t, e, n, i, s, u, l, c) {
                    ...
                    i = g[3],
                    s = g[4],
                    !(c = g[9] = void 0 === g[9] ? f ? 0 : t.length : sn(g[9] - h, 0)) && 24 & e && (e &= -25),
                    e && 1 != e)
                        m = 8 == e || 16 == e ? function(t, e, n) {
                            var i = Si(t);
                            return function o() {
                                for (var a = arguments.length, s = r(a), u = a, l = Ki(o); u--; )
                                    s[u] = arguments[u];
                                var c = a < 3 && s[0] !== l && s[a - 1] !== l ? [] : ze(s, l);
                                if ((a -= c.length) < n)
                                    return Pi(t, e, Ni, o.placeholder, void 0, s, c, void 0, void 0, n - a);
                                var f = this && this !== Vt && this instanceof o ? i : t;
                                return oe(f, this, s)
                            }
                        }(t, e, c) : 32 != e && 33 != e || s.length ? Ni.apply(void 0, g) : function(t, e, n, i) {
                            var o = 1 & e
                              , a = Si(t);
                            return function e() {
                                for (var s = -1, u = arguments.length, l = -1, c = i.length, f = r(c + u), h = this && this !== Vt && this instanceof e ? a : t; ++l < c; )
                                    f[l] = i[l];
                                for (; u--; )
                                    f[l++] = arguments[++s];
                ...
                function Bi(t, e, n, r) {
                    return void 0 === t || ja(t, bt[n]) && !Et.call(r, n) ? e : t
                }
                function Wi(t, e, n, r, i, o) {
                    return Ua(t) && Ua(e) && (o.set(e, t),
                    Dr(t, e, void 0, Wi, o),
                    o.delete(e)),
                    t
                }
                ...
                function Ui(t, e, n, r, i, o) {
                    ...
                    o.set(e, t); ++f < s; ) {
                        var p = t[f]
                          , v = e[f];
                        if (r)
                            var g = a ? r(v, p, f, e, t, o) : r(p, v, f, t, e, o);
                        if (void 0 !== g) {
                            if (g)
                                continue;
                            h = !1;
                ...
                var Xi = _n ? function(t) {
                    return _n.get(t)
                }
                : Js;
                function Yi(t) {
                    for (var e = t.name + "", n = bn[e], r = Et.call(bn, e) ? n.length : 0; r--; ) {
                        var i = n[r]
                          , o = i.func;
                        if (null == o || o == t)
                            return i.name
                ...
                function Ki(t) {
                    return (Et.call(Nn, "placeholder") ? Nn : t).placeholder
                }
                function Gi() {
                ...
                function io(t, e, n) {
                    ...
                    return o || ++r != i ? o : !!(i = null == t ? 0 : t.length) && za(i) && so(a, i) && (La(t) || Ia(t))
                }
                function oo(t) {
                    return "function" != typeof t.constructor || ho(t) ? {} : jn(Wt(t))
                }
                function ao(t) {
                ...
                function uo(t, e, n) {
                    if (!Ua(n))
                        return !1;
                    var r = typeof e;
                    return !!("number" == r ? Pa(n) && so(e, n.length) : "string" == r && e in n) && ja(n[e], t)
                }
                function lo(t, e) {
                    if (La(t))
                        return !1;
                    var n = typeof t;
                    return !("number" != n && "symbol" != n && "boolean" != n && null != t && !Ja(t)) || (U.test(t) || !z.test(t) || null != e && t in pt(e))
                }
                function co(t) {
                    var e = Yi(t)
                      , n = Nn[e];
                ...
                (dn && ro(new dn(new ArrayBuffer(1))) != T || pn && ro(new pn) != v || vn && "[object Promise]" != ro(vn.resolve()) || gn && ro(new gn) != _ || mn && ro(new mn) != x) && (ro = function(t) {
                    var e = pr(t)
                ...
                function ma(t, e, n) {
                    return e = n ? void 0 : e,
                    Mi(t, 128, void 0, void 0, void 0, void 0, e = t && null == e ? t.length : e)
                }
                function ya(t, e) {
                    var n;
                ...
                function wa(t, e, n) {
                    var r, i, a, s, u, l, c = 0, f = !1, h = !1, d = !0;
                    if ("function" != typeof t)
                        throw new mt(o);
                    function p(e) {
                        var n = r
                    ...
                    function g(t) {
                        var n = t - l;
                        return void 0 === l || n >= e || n < 0 || h && t - c >= a
                    }
                    function m() {
                        var t = ga();
                        if (g(t))
                    ...
                    return e = as(e) || 0,
                    Ua(n) && (f = !!n.leading,
                    a = (h = "maxWait"in n) ? sn(as(n.maxWait) || 0, e) : a,
                ...
                function Ta(t, e) {
                    ...
                    return n.cache = new (Ta.Cache || Pn),
                    n
                }
                function Ca(t) {
                    if ("function" != typeof t)
                ...
                var Sa = li((function(t, e) {
                    var n = (e = 1 == e.length && La(e[0]) ? de(e[0], De(Gi())) : de(ar(e, 1), De(Gi()))).length;
                ...
                var Da = Ri(vr)
                  ...
                  , Ia = br(function() {
                    ...
                    return $a(t) && Et.call(t, "callee") && !Qt.call(t, "callee")
                }
                  , La = r.isArray
                  , Ra = Zt ? De(Zt) : function(t) {
                    return $a(t) && pr(t) == E
                }
                ;
                function Pa(t) {
                ...
                function Ma(t) {
                    if (!$a(t))
                        return !1;
                    var e = pr(t);
                    return e == h || "[object DOMException]" == e || "string" == typeof t.message && "string" == typeof t.name && !Xa(t)
                }
                function Ba(t) {
                    if (!Ua(t))
                        return !1;
                ...
                var Ya = ne ? De(ne) : function(t) {
                    return $a(t) && pr(t) == y
                }
                ;
                var Ka = re ? De(re) : function(t) {
                    return $a(t) && ro(t) == _
                }
                ;
                function Ga(t) {
                    return "string" == typeof t || !La(t) && $a(t) && pr(t) == b
                }
                function Ja(t) {
                    return "symbol" == typeof t || $a(t) && pr(t) == w
                }
                var Za = ie ? De(ie) : function(t) {
                ...
                var ps = Hr((function(t, e) {
                    ...
                    for (i && uo(e[0], e[1], i) && (r = 1); ++n < r; )
                        for (var o = e[n], a = xs(o), s = -1, u = a.length; ++s < u; ) {
                            var l = a[s]
                              , c = t[l];
                            (void 0 === c || ja(c, bt[l]) && !Et.call(t, l)) && (t[l] = o[l])
                        }
                    return t
                }
                ))
                  , vs = Hr((function(t) {
                    return t.push(void 0, Wi),
                    oe(Ts, void 0, t)
                }
                ));
                function gs(t, e, n) {
                ...
                function Gs(t, e, n) {
                    var r = ws(e)
                      , i = fr(e, r);
                    null != n || Ua(e) && (i.length || !r.length) || (n = e,
                    e = t,
                    t = this,
                    i = fr(e, ws(e)));
                ...
                var su = Di((function(t, e) {
                  ...
                  , cu = qi("floor");
                var fu, hu = Di((function(t, e) {
                    return t * e
                }
                ), 1), du = qi("round"), pu = Di((function(t, e) {
                    return t - e
                }
                ), 0);
                ...
                Nn.curry = function t(e, n, r) {
                    var i = Mi(e, 8, void 0, void 0, void 0, void 0, void 0, n = r ? void 0 : n);
                    return i.placeholder = t.placeholder,
                    i
                }
                ,
                Nn.curryRight = function t(e, n, r) {
                    var i = Mi(e, 16, void 0, void 0, void 0, void 0, void 0, n = r ? void 0 : n);
                    return i.placeholder = t.placeholder,
                    i
                }
                ,
                ...
                Nn.pullAllBy = function(t, e, n) {
                    return t && t.length && e && e.length ? Rr(t, e, Gi(n, 2)) : t
                }
                ,
                ...
                Nn.split = function(t, e, n) {
                    ...
                    (n = void 0 === n ? 4294967295 : n >>> 0) ? (t = us(t)) && ("string" == typeof e || null != e && !Ya(e)) && !(e = Jr(e)) && Me(t) ? ci(Ve(t), 0, n) : t.split(e, n) : []
                }
                ,
                ...
                Nn.toPath = function(t) {
                    return La(t) ? de(t, ko) : Ja(t) ? [t] : yi(So(us(t)))
                }
                ,
                Nn.toPlainObject = ss,
                ...
                Nn.escape = function(t) {
                    return (t = us(t)) && H.test(t) ? t.replace(q, Fe) : t
                }
                ,
                Nn.escapeRegExp = function(t) {
                    return (t = us(t)) && V.test(t) ? t.replace(Q, "\\$&") : t
                }
                ,
                ...
                Nn.includes = function(t, e, n, r) {
                    ...
                    Ga(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && we(t, e, n) > -1
                }
                ,
                ...
                Nn.isEmpty = function(t) {
                    if (null == t)
                        return !0;
                    if (Pa(t) && (La(t) || "string" == typeof t || "function" == typeof t.splice || Fa(t) || Za(t) || Ia(t)))
                        return !t.length;
                    var e = ro(t);
                    if (e == v || e == _)
                        return !t.size;
                ...
                Nn.random = function(t, e, n) {
                    ...
                    if (n || t % 1 || e % 1) {
                        var i = fn();
                        return un(t + i * (e - t + zt("1e-" + ((i + "").length - 1))), e)
                    }
                    return qr(t, e)
                }
                ,
                ...
                Nn.template = function(t, e, n) {
                    ...
                    t = us(t),
                    e = fs({}, e, r, Bi);
                    var i, o, a = fs({}, e.imports, r.imports, Bi), s = ws(a), u = Oe(a, s), l = 0, c = e.interpolate || ct, f = "__p += '", h = vt((e.escape || ct).source + "|" + c.source + "|" + (c === W ? nt : ct).source + "|" + (e.evaluate || ct).source + "|$", "g"), d = "//# sourceURL=" + (Et.call(e, "sourceURL") ? (e.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Ht + "]") + "\n";
                ...
                Nn.toSafeInteger = function(t) {
                    return t ? Kn(is(t), -9007199254740991, 9007199254740991) : 0 === t ? t : 0
                }
                ,
                Nn.toString = us,
                ...
                Nn.unescape = function(t) {
                    return (t = us(t)) && F.test(t) ? t.replace(P, Ye) : t
                }
                ,
                ...
                lr(In.prototype, (function(t, e) {
                    var n = /^(?:filter|find|map|reject)|While$/.test(e)
                      , r = /^(?:head|last)$/.test(e)
                      , i = Nn[r ? "take" + ("last" == e ? "Right" : "") : e]
                      , o = r || /^find/.test(e);
                    i && (Nn.prototype[e] = function() {
                        ...
                        return d && p ? t.apply(this, a) : (v = this.thru(c),
    ...
    !function(t, e, n) {
        ...
        var v = "carousel"
          ...
          , w = function() {
            ...
            n._slide = function(t, n) {
                var r, i, o, a = this, s = this._element.querySelector(".active.carousel-item"), u = this._getItemIndex(s), c = n || s && this._getItemByDirection(t, s), f = this._getItemIndex(c), h = Boolean(this._interval);
            ...
            t._jQueryInterface = function(n) {
                return this.each((function() {
                    var r = e(this)
                      ...
                      , o = s(s(s({}, T), r.data()), "object" == typeof n && n ? n : {});
        ...
        var k = "dropdown"
          ...
          , O = function() {
                ...
                !(this._element.disabled || e(this._element).hasClass("disabled") || e(this._menu).hasClass("show"))) {
                    ...
                    !o.isDefaultPrevented()) {
                        if (!this._inNavbar && r) {
                            ...
                            var s = this._element;
                            "parent" === this._config.reference ? s = a : l.isElement(this._config.reference) && (s = this._config.reference,
            ...
            r._getConfig = function(t) {
                ...
                l.typeCheckConfig(k, t, this.constructor.DefaultType),
                t
            }
            ,
            ...
            t._dataApiKeydownHandler = function(n) {
                if (!(/input|textarea/i.test(n.target.tagName) ? 32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || e(n.target).closest(".dropdown-menu").length) : !N.test(n.which)) && !this.disabled && !e(this).hasClass("disabled")) {
            ...
            t._jQueryInterface = function(n, r) {
                return this.each((function() {
                    var i = e(this).data("bs.modal")
                      , o = s(s(s({}, L), e(this).data()), "object" == typeof n && n ? n : {});
                    if (i || (i = new t(this,o),
            ...
            for (var r = (new window.DOMParser).parseFromString(t, "text/html"), i = Object.keys(e), o = [].slice.call(r.body.querySelectorAll("*")), a = function(t, n) {
                ...
                s.forEach((function(t) {
                    (function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n))
                            return -1 === q.indexOf(n) || Boolean(t.nodeValue.match(H) || t.nodeValue.match(M));
        ...
        var W = "tooltip"
          ...
          , K = function() {
            ...
            r.setElementContent = function(t, n) {
                "object" != typeof n || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = B(n, this.config.whiteList, this.config.sanitizeFn)),
            ...
            r._getConfig = function(t) {
                ...
                l.typeCheckConfig(W, t, this.constructor.DefaultType),
                t.sanitize && (t.template = B(t.template, t.whiteList, t.sanitizeFn)),
                t
            }
            ,
        ...
        var it = "scrollspy"
          ...
          , ut = function() {
            ...
            ,
            n._getConfig = function(t) {
                if ("string" != typeof (t = s(s({}, at), "object" == typeof t && t ? t : {})).target && l.isElement(t.target)) {
                    var n = e(t.target).attr("id");
                    n || (n = l.getUID(it),
                    e(t.target).attr("id", n)),
                    t.target = "#" + n
                }
                return l.typeCheckConfig(it, t, st),
                t
            }
            ,
          ...
          , ct = function() {
            ...
            return n.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass("active") || e(this._element).hasClass("disabled"))) {
                    var n, r, i = e(this._element).closest(".nav, .list-group")[0], o = l.getSelectorFromElement(this._element);
                    if (i) {
        ...
        var ft = e.fn.toast
          ...
          , pt = function() {
            ...
            ,
            n._getConfig = function(t) {
                return t = s(s(s({}, dt), e(this._element).data()), "object" == typeof t && t ? t : {}),
    ...
    !function(t) {
        ...
        window.refreshCaptcha = function() {
            captcha_src((function(e) {
                e ? t(".captcha-image").attr("src", e) : t(".captcha-image").closest(".form-group").find(".help-block").html("مشکلی پیش آمده لطفا دوباره تلاش کنید.")
            }
            ))
        }
    }(jQuery)
